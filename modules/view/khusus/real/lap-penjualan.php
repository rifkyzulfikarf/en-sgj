				...
				<div class="panel-body">
					...
					?>
						...
						<div id="print-section">
							<div class="text-center"><h3>Laporan Penjualan Khusus</h3></div><hr>
							...
							<table class="table table-hover table-striped table-mod">
								...
								<tbody>
									...
									$query = "SELECT `khusus_penjualan`.*, `konsumen`.`nama` AS `nama_konsumen`, 
									`khusus_penjualan`.`id` 
									FROM `khusus_penjualan` 
									INNER JOIN `konsumen` ON (`khusus_penjualan`.`id_konsumen` = `konsumen`.`id`) 
									WHERE `khusus_penjualan`.`id_bank` = '1' AND `khusus_penjualan`.`id_barang` = '1' 
									AND `khusus_penjualan`.`id_konsumen` LIKE '".$_POST['cmb-konsumen']."' 
									AND `khusus_penjualan`.`jenis` LIKE '".$_POST['cmb-jenis']."' 
									AND `khusus_penjualan`.`tgl` BETWEEN '".$_POST['tgl-awal']."' AND '".$_POST['tgl-akhir']."';";
									...
									if ($daftar = $data->runQuery($query)) {
										while( $rs = $daftar->fetch_assoc() ) {
											...
											echo "<tr>
												...
												<td class='text-center'>LPG 50Kg Khusus</td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<input type="hidden" id="no_spa" name="no_spa" value="<?php echo e_url('modules/view/khusus/real/lap-penjualan.php'); ?>">
