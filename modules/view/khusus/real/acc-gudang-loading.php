...
$(document).ready(function(){
	...
	var tabelloading = $('#tabel-loading').dataTable({
		...
		"fnServerParams": function ( aoData ) {
            aoData.push({"name": "aksi", "value": "<?php echo e_url('modules/controller/khusus/acc-gudang-loading.php'); ?>"});
	...
	$('#btn-simpan-acc-out').click(function(ev){
		ev.preventDefault();
		var post_data = "aksi=" + "<?php echo e_url('modules/controller/khusus/acc-gudang-loading.php'); ?>" + "&" +$('#frm-acc-out').serialize();
	...
	$('#btn-simpan-acc-in').click(function(ev){
		ev.preventDefault();
		var post_data = "aksi=" + "<?php echo e_url('modules/controller/khusus/acc-gudang-loading.php'); ?>" + "&" +$('#frm-acc-in').serialize();
		if (confirm('Simpan data ?')) {
