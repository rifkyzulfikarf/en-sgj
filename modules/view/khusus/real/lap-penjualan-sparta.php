				...
				<div class="panel-body">
					...
					?>
						...
						<div id="print-section">
							<div class="text-center"><h3>Laporan Penjualan Sparta</h3></div><hr>
							...
							<table class="table table-hover table-striped table-mod">
								...
								<tbody>
									...
									WHERE `khusus_penjualan`.`id_bank` = '1' AND `khusus_penjualan`.`id_barang` = '2' 
									...
									if ($daftar = $data->runQuery($query)) {
										while( $rs = $daftar->fetch_assoc() ) {
											...
											echo "<tr>
												...
												<td class='text-center'>LPG 3Kg</td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<input type="hidden" id="no_spa" name="no_spa" value="<?php echo e_url('modules/view/khusus/real/lap-penjualan-sparta.php'); ?>">
