...
$(document).ready(function(){
	...
	var tabelstok = $('#tabel-stok').dataTable({
		...
		"fnServerParams": function ( aoData ) {
            aoData.push({"name": "aksi", "value": "<?php echo e_url('modules/controller/khusus/stok.php'); ?>"});
	...
	$('#btn-simpan-opname').click(function(ev){
		ev.preventDefault();
		var post_data = "aksi=" + "<?php echo e_url('modules/controller/khusus/stok.php'); ?>" + "&" +$('#frm-opname').serialize();
