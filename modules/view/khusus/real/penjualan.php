...
$(document).ready(function(){
	...
	function reloading(){
		$.ajax({
			...
			method: "POST",
			cache: false,
			data: {"mod" : "<?php echo e_url('modules/view/khusus/real/penjualan.php'); ?>"},
	...
	function init(){
		...
		$.ajax({
			...
			method: "POST",
			cache: false,
			data: {"aksi" : "<?php echo e_url('modules/controller/khusus/penjualan.php'); ?>", "apa" : "get-sales"},
			success: function(event){
				$('#cmb-sales').empty();	
		...
		$.ajax({
			...
			method: "POST",
			cache: false,
			data: {"aksi" : "<?php echo e_url('modules/controller/khusus/penjualan.php'); ?>", "apa" : "get-barang"},
			success: function(event){
				$('#cmb-barang').empty();	
		...
		$.ajax({
			...
			method: "POST",
			cache: false,
			data: {"aksi" : "<?php echo e_url('modules/controller/khusus/penjualan.php'); ?>", "apa" : "get-konsumen"},
			success: function(event){
				$('#cmb-konsumen').empty();	
		...
		$.ajax({
			...
			method: "POST",
			cache: false,
			data: {"aksi" : "<?php echo e_url('modules/controller/khusus/penjualan.php'); ?>", "apa" : "get-bank"},
			success: function(event){
				$('#cmb-bank').empty();	
				$('#cmb-bank').html(event);
			},
	...
	$('#btn-cek').click(function(ev){
		...
		$.ajax({
			...
			cache: false,
			dataType: "JSON",
			data: {"aksi" : "<?php echo e_url('modules/controller/khusus/penjualan.php'); ?>", 
	...
	$('#btn-simpan').click(function(ev){
		...
		if (confirm("Harap cek kembali data - data yang anda masukkan ! Simpan penjualan ?")) {
			...
			var post_data = {"aksi" : "<?php echo e_url('modules/controller/khusus/penjualan.php'); ?>", "apa" : "simpan", 
