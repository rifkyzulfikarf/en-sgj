									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<select class="form-control" id="cmb-barang" name="cmb-barang">
												<option value="<?php echo $_POST['idbarang'] ?>" data-het="<?php echo $_POST['het'] ?>"><?php echo $_POST['namabarang'] ?></option>
											</select>
										</div>
									</div>
								</form>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<select class="form-control" id="cmb-konsumen" name="cmb-konsumen">
												<option value="<?php echo $_POST['idkonsumen'] ?>"><?php echo $_POST['namakonsumen'] ?></option>
											</select>
										</div>
									</div>
								</form>
							...
							<section class="panel">
								<form class="form-horizontal tasi-form">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control" name="txt-jml" id="txt-jml" 
											value="<?php echo $_POST['jml'] ?>" readonly>
										</div>
									</div>
								</form>
							</section>
...
$(document).ready(function(){
	...
	$('#btn-simpan').click(function(ev){
		...
		var idpesanan = "<?php echo $_POST['id'] ?>";
