	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button class="btn btn-primary" type="button" id="btn-simpan-data">Tambah Dana</button>
			</div>
		</div>
	</div>
</div>
...
$(document).ready(function(){
	...
	function init() {
		...
		$.ajax({
			...
			method: "POST",
			cache: false,
			data: {"aksi" : "<?php echo e_url('modules/controller/keuangan/tambah_dana_kasir.php'); ?>", "apa" : "get-akun"},
	...
	var tabelkasir = $('#tabel-kasir').dataTable({
		...
		"fnServerParams": function ( aoData ) {
            aoData.push({"name": "aksi", "value": "<?php echo e_url('modules/controller/keuangan/tambah_dana_kasir.php'); ?>"});
            aoData.push({"name": "apa", "value": "get-kasir"});
        }
    });
	
	$('#tabel-kasir').on('click', '#btn-tambah-dana', function(ev){
		ev.preventDefault();
	...
	$('#btn-simpan-data').click(function(ev){
		ev.preventDefault();
		var post_data = "aksi=" + "<?php echo e_url('modules/controller/keuangan/tambah_dana_kasir.php'); ?>" + "&" +$('#frm-kasir').serialize();
		if (confirm('Setuju tambahkan dana pada kasir ?')) {
