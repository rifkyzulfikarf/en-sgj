	...
	if (isset($_POST['apa']) && $_POST['apa'] != "") {
		...
		switch ($_POST['apa']) {
			...
			case "simpan-opname":
				...
				isset($_POST['txt-pinjam-lama']) && $_POST['txt-pinjam-lama'] != "" && isset($_POST['txt-pinjam-baru']) && $_POST['txt-pinjam-baru'] != "") {
					
					$tgl = date("Y-m-d");
					
					if ($result = $barang->stok_opname($tgl, $_POST['txt-id'], $_POST['txt-isi-lama'], $_POST['txt-isi-baru'], 
					$_POST['txt-kosong-lama'], $_POST['txt-kosong-baru'], $_POST['txt-pinjam-lama'], $_POST['txt-pinjam-baru'],
